...
import functionalInterface.task.MathOperation;
...
public class Calculator {
    ...
    public static Map<String, functionalInterface.task.MathOperation> map = new HashMap<>();
    ...
    public static int calculate(String expression) {
        ...
        for (int i = 1; i < exps.length; i = i + 2) {
            functionalInterface.task.MathOperation op = map.get(exps[i]);
